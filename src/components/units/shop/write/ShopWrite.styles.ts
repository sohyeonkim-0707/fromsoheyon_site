...
interface IShopWriteStyleProps {
  isActive: boolean;
}

export const Container = styled.form`
  padding: 191px 153px 100px 153px;
...
export const SubmitBtn = styled(BackBtn)`
  background-color: ${(props: IShopWriteStyleProps) =>
    props.isActive ? "#184124" : ""};
  color: ${(props: IShopWriteStyleProps) => (props.isActive ? "white" : "")};
`;
